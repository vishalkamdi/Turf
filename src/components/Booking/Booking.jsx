...
const Booking = () => {
  const { getters } = BookingController();
  const { firstName, lastName, email, startTime, endTime, date } = getters;

  return (
    <div className=" bg-green-50 max-w-sm w-full lg:max-w-full lg:flex flex justify-center p-4">
